...
import { Mail, MapPin, Send, Github, Linkedin, Twitter, Copy, Check, Zap, MessageSquare } from "lucide-react";
        ...
        >
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ...
              creative ideas, or chances to be part of your vision.
            </p>
          </div>
                  ...
                  {formState.success ? (
                    ...
                    >
                      ...
                      <Button 
                        variant="outline" 
                        className="mt-6"
                        onClick={() => setFormState({ success: false, error: false })}
                      >
                        Send Another
                      </Button>
                    </motion.div>
